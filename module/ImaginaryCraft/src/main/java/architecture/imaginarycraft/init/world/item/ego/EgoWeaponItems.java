...
import architecture.imaginarycraft.common.world.item.ego.weapon.melee.knife.KnifeEgoWeaponItem;
import architecture.imaginarycraft.common.world.item.ego.weapon.melee.mace.MaceEgoWeaponItem;
import architecture.imaginarycraft.common.world.item.ego.weapon.melee.spear.SpearEgoWeaponItem;
import architecture.imaginarycraft.common.world.item.ego.weapon.melee.special.*;
import architecture.imaginarycraft.common.world.item.ego.weapon.melee.swords.SwordsEgoWeaponGeoItem;
import architecture.imaginarycraft.common.world.item.ego.weapon.remote.RemoteEgoWeaponItem;
import architecture.imaginarycraft.common.world.item.ego.weapon.remote.cannon.CannonEgoWeaponItem;
import architecture.imaginarycraft.common.world.item.ego.weapon.remote.crossbow.CrossbowEgoWeaponGeoItem;
import architecture.imaginarycraft.common.world.item.ego.weapon.remote.gun.MagicBulletWeaponItem;
import architecture.imaginarycraft.common.world.item.ego.weapon.remote.gun.PistolEgoWeaponItem;
import architecture.imaginarycraft.common.world.item.ego.weapon.remote.gun.SolemnLamentWeaponItem;
import architecture.imaginarycraft.common.world.item.ego.weapon.remote.gun.pistol.PinkWeaponItem;
import architecture.imaginarycraft.common.world.item.ego.weapon.remote.gun.rifle.RifleEgoWeaponItem;
import architecture.imaginarycraft.common.world.item.ego.weapon.remote.special.*;
