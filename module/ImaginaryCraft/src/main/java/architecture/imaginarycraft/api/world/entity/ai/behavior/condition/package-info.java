 ...
 * <h2>主要组件：</h2>
 * <ul>
 *   <li>{@link architecture.imaginarycraft.api.world.entity.ai.behavior.condition.ConditionBT} - 条件接口（函数式接口）</li>
 *   <li>{@link architecture.imaginarycraft.api.world.entity.ai.behavior.condition.AbstractConditionLeaf} - 条件叶节点抽象基类</li>
 * </ul>
 *
 * <h2>内置条件：</h2>
 * <ul>
 ...
 * </pre>
 */
package architecture.imaginarycraft.api.world.entity.ai.behavior.condition;
