 ...
 * <h2>主要组件：</h2>
 * <ul>
 *   <li>{@link architecture.imaginarycraft.api.world.entity.ai.behavior.decoration.DecorationNode} - 装饰节点抽象基类（包含单个子节点）</li>
 *   <li>{@link architecture.imaginarycraft.api.world.entity.ai.behavior.decoration.ConditionNode} - 条件装饰节点（执行前检查条件）</li>
 * </ul>
 *
 * <h2>功能特性：</h2>
 * <ul>
 ...
 * </pre>
 */
package architecture.imaginarycraft.api.world.entity.ai.behavior.decoration;
