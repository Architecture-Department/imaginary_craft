...
- Mixin 实现：`src/main/java/architecture/imaginarycraft/mixin/world/skill/WeaponTypeReloadListenerMixin.java`
- 工具类：`src/main/java/architecture/imaginarycraft/api/data/ModWeaponTypeReloadListener.java`
